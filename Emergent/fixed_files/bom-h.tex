\subsection*{Bill of Materials: CatCore Heart SKU}
...
% FIX: Corrected typo 'Refridegrate' to 'Refrigerate' and removed extra space/tab before \\
...
\midrule
% FIX: Added missing \\ at end of row
...
% FIX: The line below must be inside a list environment to follow the subsubsection.
\begin{itemize}
...
% FIX: Corrected misplaced \textbf command and extra space/tabs.
...
% FIX: Corrected typo 'Useage' to 'Usage'.
...
% FIX: The next three lines were concatenated with the text of the previous item. They must be separate items.
...
% FIX: Added space after 'Blend:}' and used $\le$ for the math symbol.
