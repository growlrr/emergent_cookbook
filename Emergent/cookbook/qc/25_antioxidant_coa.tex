...
% --- DEBUGGED: Column widths now use \textwidth and \dimexpr to fill the space correctly.
\begin{tabular}{@{}p{0.3\textwidth}p{\dimexpr 0.7\textwidth - 2\tabcolsep}@{}}
\toprule
...
% --- IMPROVEMENT: Reduced excessive precision
...
% --- IMPROVEMENT: Changed 'deg C' to '$^\circ$C'
...
% --- DEBUGGED: Removed '&' from start of this line
...
% --- DEBUGGED: Corrected 'SKUssa' typo
